...
public class QuestionDetailsActivity extends AppCompatActivity {
    ...
    private String hisuid, ptime, myuid, myname, myemail, mydp, uimage, postId, hisdp, hisname;
    ...
    private void postComment() {
        ...
        if (TextUtils.isEmpty(commentss)) {
            Toast.makeText(QuestionDetailsActivity.this, "Empty comment", Toast.LENGTH_LONG).show();
            return;
        }
        progressDialog.show();
        ...
        datarf.child(timestamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(QuestionDetailsActivity.this, "Added", Toast.LENGTH_LONG).show();
                comment.setText("");
                updateCommentCount();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(QuestionDetailsActivity.this, "Failed", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void updateCommentCount() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(QuestionDetailsActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        userRef.orderByChild("uid").equalTo(myuid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (mydp != null) {
                        Glide.with(QuestionDetailsActivity.this).load(mydp).into(imagep);
                    }
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if ("noImage".equals(uimage)) {
                        ...
                        if (uimage != null) {
                            Glide.with(QuestionDetailsActivity.this).load(uimage).into(image);
                        }
                    }

                    if (hisdp != null) {
                        Glide.with(QuestionDetailsActivity.this).load(hisdp).into(picture);
                    }
                }
            }
