...
public class HomeFragment extends Fragment {
    ...
    // retrieves the list of users you follow and then calls loadPosts
    ...
    // filters posts to include only those from users you follow or your own
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (modelPost != null && modelPost.getUid() != null && (followingUserIds.contains(modelPost.getUid()) || modelPost.getUid().equals(myuid))) {
                        posts.add(modelPost);
                    }
                }
